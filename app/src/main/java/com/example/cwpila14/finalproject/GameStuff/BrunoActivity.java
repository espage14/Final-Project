...
public class BrunoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_bruno);
        getWindow().getAttributes().windowAnimations = R.style.Fade;

        this.fight = (Button) findViewById(R.id.bruno_fight);
        ...
        fight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // send to home screen
                Intent intent = new Intent(BrunoActivity.this, BattleActivity.class);
                intent.putExtra("activity", "bruno");
                BrunoActivity.this.startActivity(intent);
            }
        });
