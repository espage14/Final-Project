...
public class LoserActvity extends Activity {
    Button home;
    // sound stuff
    SoundPool s = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.home = (Button) findViewById(R.id.exitGameButton);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // send to home screen
                Intent intent = new Intent(LoserActvity.this, MainActivity.class);
                LoserActvity.this.startActivity(intent);
            }
        });
    }
