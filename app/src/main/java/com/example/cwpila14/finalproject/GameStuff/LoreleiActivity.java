...
public class LoreleiActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_lorelei);
        getWindow().getAttributes().windowAnimations = R.style.Fade;

        this.fight = (Button) findViewById(R.id.lorelei_fight);
        ...
        fight.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // send to home screen
                Intent intent = new Intent(LoreleiActivity.this, AgathaActivity.class);
                LoreleiActivity.this.startActivity(intent);
            }
        });
